export const ROUTES_SCHEMA_SQL_PATH = "migrations/0001_initial_schema.sql";

// Keep this in sync with migrations/0001_initial_schema.sql so the admin UI
// can copy the initialization SQL directly into the D1 console.
export const ROUTES_SCHEMA_SQL = `CREATE TABLE IF NOT EXISTS routes (
